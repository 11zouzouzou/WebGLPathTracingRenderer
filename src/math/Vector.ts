...
export class Vector {
  ...
  distanceFrom(obj: { [id in string]: any }) {
    if (obj.anchor) {
  ...
  reflectionIn(obj: { [id in string]: any }) {
    if (obj.anchor) {
  ...
  setElements(els: number[] | { elements: number[] }) {
    if (Array.isArray(els)) {
      this.elements = els.slice();
    } else {
      this.elements = els.elements.slice();
    }
    return this;
  }
}
